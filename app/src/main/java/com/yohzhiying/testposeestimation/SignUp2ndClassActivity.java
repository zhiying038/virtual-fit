...
public class SignUp2ndClassActivity extends AppCompatActivity {
    ...
    public void call3rdSigupScreen(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), SignUp3rdClassActivity.class);
        ...
        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(SignUp2ndClassActivity.this, pairs);
